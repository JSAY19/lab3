...
namespace UnitTestForpraktika3
{
	...
	public:
		...
		TEST_METHOD(DateLeapYearTest) // Этот код тестирует високосный и невисокосный год. Первый тест проверяет корректность вывода даты 29 февраля для високосного года, а второй тест гарантирует обработку попытки чтения некорректной даты 29 февраля в невисокосном году, ожидая выброс исключения std::invalid_argument.
		{
			Date date;
			date.year = 2024;
			date.month = 2;
